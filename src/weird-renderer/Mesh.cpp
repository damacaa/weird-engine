...
namespace WeirdEngine
{
	namespace WeirdRenderer
	{
		...
		void Mesh::DrawInstance(Shader& shader, Camera& camera, unsigned int instances, glm::vec3 translation, glm::vec3 rotation, glm::vec3 scale, const std::vector<Light>& lights) const
		{
			// Bind shader to be able to access uniforms
			shader.activate();
			m_vao.Bind();
